(function () {
    ...
    */
    ...
    registerRoute(/\.(?:css|js)$/, new StaleWhileRevalidate({
        cacheName: 'assets',
        plugins: [
    ...
    registerRoute(/\.(?:md|json)$/, new CacheFirst({
        cacheName: 'content',
        plugins: [
            new ExpirationPlugin({
                maxEntries: 1000,
    ...
    registerRoute(/\.(?:woff2|woff|ttf)$/, new CacheFirst({
        cacheName: 'fonts',
        plugins: [
            new ExpirationPlugin({
                maxEntries: 1000,
    ...
    registerRoute(/\.(?:png|jpg|jpeg|gif|bmp|webp|svg|ico)$/, new CacheFirst({
        cacheName: 'images',
        plugins: [
            new ExpirationPlugin({
                maxEntries: 1000,
    ...
    registerRoute(/\.(?:html|htm|js|map)$/, new NetworkFirst({
        cacheName: 'app',
        plugins: [
            new ExpirationPlugin({
                maxAgeSeconds: 60 * 60,
